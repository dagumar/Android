...
public class FormActivity extends Activity implements OnItemSelectedListener{
	...
	public void enviarClick(View view) {
		...
		Intent request = new Intent(FormActivity.this, RecuperarValores.class);
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
		...
		if(item.getTitle().equals(this.getString(R.string.ayuda))){
			Toast.makeText(FormActivity.this, "En construcción", Toast.LENGTH_LONG).show();
	...
	public void mostrarAlerta(String titulo, String texto){
		...
		alert.setNeutralButton("Ok", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				Toast.makeText(FormActivity.this, "Donaciones a través de Paypal!! ", Toast.LENGTH_LONG).show();
			}
		});
		alert.show();
